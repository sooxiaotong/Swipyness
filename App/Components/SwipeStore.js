...
import styles from './Styles/SwipeStoreStyle'

export default class SwipeStore extends Component {
  // // Prop type warnings
  // static propTypes = {
  ...
  render () {
    ...
    const { type, picture, username, name, time, text, url, price, profile } = this.props
    return (
